...
for patchline in patchlines:
    ...
    level = json_data["keystone.self_update.level"]
    manifest_url = json_data["keystone.self_update.manifest_url"]
    ...
    save_file(f"Riot Client/{patchline}/{exe_version}_{level}.json", json.dumps(json_data, sort_keys=True, separators=(',', ':')))
